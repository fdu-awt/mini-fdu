...
export default class PlayerController {
	...
	handleKeyboardControlRequest() {
		...
		gameEventEmitter
			...
			.offWithDebounce(GAME_EVENTS.KEY_DOWN_V, this.key_down_v)
			.offWithDebounce(GAME_EVENTS.KEY_DOWN_E, this.key_down_e)
			.offWithDebounce(GAME_EVENTS.KEY_DOWN_Q, this.key_down_q)
